...
After looking at the overview of the manufacturing department, one can navigate to the Product Category Page for a more detailed analysis. This will help identify specific issues in the manufacturing system. 
...
Another major component of the dashboard is the Inventory overview. Although there is no data regarding the distribution supply chain in the database, this analysis is done assuming there is one location.

Main Page

The overview includes 3 KPIs, 3 Filters to slice the data, and 2 charts.
...
Area charts showing how much Inventory quantity and Inventory value the company holds by the Assembly location category are shown in the area chart. This shows which part of the manufacturing is holding most of the money and if the company is making the right choices of investing in those parts. There is a button on top of the chart so the end-user can choose if he wants to view the quantity or value on the chart.
...
### About the Developer
Aarthi Reddy Jannapureddy is a Data Analyst with over 3 years of experience specializing in SQL, Power BI, and Python. She has a proven track record of delivering actionable insights and automated reporting solutions in retail and enterprise environments. This project reflects her commitment to technical excellence and her ability to transform raw ERP data into strategic business intelligence.